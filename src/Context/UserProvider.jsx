...
const UserProvider = ({children}) => {
  ...
  return (
    <UserContext value={{userDetails,setUserDetails,requests,totalRequests,friends,totalFriends,currentTalk,setCurrentTalk,currentName,setCurrentName,onlineArr,setOnlineArr,recentChats,setRecentChats,recentSearchedForOnline,randomImage,lastMessages,setLastMessages}}>
      {children}
    </UserContext>
  )
}
